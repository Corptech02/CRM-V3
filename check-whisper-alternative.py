...
api_key = os.environ.get('OPENAI_API_KEY') or os.environ.get('VANGUARD_OPENAI_KEY')

if not api_key:
    print("ERROR: OpenAI API key not found. Please set OPENAI_API_KEY or VANGUARD_OPENAI_KEY environment variable.")
    exit(1)
